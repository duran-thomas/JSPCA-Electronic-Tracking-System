...
public class VetClinicReportMenuh {
	...
	private void initialize() {
		...
		JLabel lblVetClinic = new JLabel("Vet Clinic");
		...
		JButton btnByVisitDate = new JButton("By Visit Date");
		btnByVisitDate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						try {
							SearchByDateVet window = new SearchByDateVet();
							window.frame.setVisible(true);
						} catch (Exception e) {
							e.printStackTrace();
						}
